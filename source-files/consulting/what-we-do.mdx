...
features:
  ...
  - title: Validate
    description: >
      We work with stakeholders to articulate the vision internally, and use a concise written narative to make sure everyone is aligned.
  ...
  - title: Build
    description: >
      ...
      We focus on getting new features to market fast by deliverying incremental essential value to customers along the way.
